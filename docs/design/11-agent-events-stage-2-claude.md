...
| Codex, OpenCode       | yes                 | Not started. The reading in [10 §6](10-agent-events-stage-1.md#6--stage-0-baseline-and-the-stage-2-coverage-matrix) stands; fixtures first, as here.                                                                                                                                   |
