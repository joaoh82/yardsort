...
const POINTS = [
  ...
  },
  {
    ...
    body: "A local note of when each agent started in a workspace and how it ended — even while the window was closed — without reading a word it printed. Opt in, and Claude Code and Codex report their own tool calls and turns to it as metadata. An experimental timeline shows it; ys activity export writes it out.",
  },
  {
