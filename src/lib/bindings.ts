...
export const commands = {
	...
	settingsSaveActivity: (recordLifecycle: boolean, showTimeline: boolean, captureClaude: boolean, captureCodex: boolean, captureOpencode: boolean) => typedError<SettingsInfo, IpcError>(__TAURI_INVOKE("settings_save_activity", { recordLifecycle, showTimeline, captureClaude, captureCodex, captureOpencode })),
